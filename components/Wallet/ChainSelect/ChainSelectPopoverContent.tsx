...
import { ChainList } from 'components/Wallet/ChainSelect/ChainList/ChainList'

import NetworkForm from './NetworkForm/NetworkForm'

export const ChainSelectPopoverContent = ({ onChange, onClose, currentChainState, connectedChainIds }) => (
  <PopoverContent
    borderColor="#1C1C1C"
    borderRadius="30px"
