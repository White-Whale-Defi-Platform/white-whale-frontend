...
function NetworkSwitch() {
  ...
  const changeNetwork = ({target}) => {
    ...
    const updatedChainId = currentWalletState.chainId === 'migaloo-1' && target.checked ?
      "narwhal-1" : currentWalletState.chainId === 'narwhal-1' && !target.checked ?
        "migaloo-1" : currentWalletState.chainId
    setWalletState({
      ...currentWalletState,
