...
export const getFeeDistributorConfig = async (client: Wallet, config: Config) => {
  if (!client) {
    return null
  }
...
const fetchConfig = async (client: Wallet, config: Config): Promise<FeeDistributionConfig> => {
