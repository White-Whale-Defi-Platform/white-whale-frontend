...
export const ActionCTAs = ({ chainIdParam, pool }) => {
  ...
  return (
    <HStack spacing={2}>
      <Button variant="outline" size="sm" onClick={onManageLiquidityClick}> Manage Liquidity</Button>
      <Button variant="outline" size="sm" onClick={onIncentivizeClick} isDisabled={!isIncentivized} > Incentivize</Button>
    </HStack>
  );
};
