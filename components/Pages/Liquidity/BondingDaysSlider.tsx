    ...
    return (
        <VStack width="full" alignItems="flex-start" gap="2" pb="6">
            ...
            <TooltipWithChildren label="Unbonding Duration">
                <Text>Unbonding Duration refers to the period of time it takes for your staked funds to be released</Text>
            </TooltipWithChildren>

            <Box width="full">
                <Slider defaultValue={0} value={value} step={1} min={0} max={365} borderRadius={100} height={1.5} onChange={setValue}>
            ...
            <HStack gap="4">
                <Box px="10" py="2" bg="rgba(0, 0, 0, 0.5)" borderRadius="100px">
                    <Text color="white" fontSize="14"> ~{value} days</Text>
                </Box>
