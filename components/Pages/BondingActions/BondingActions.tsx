...
const BondingActions: FC<Props> = ({ globalAction }) => {
        ...
        <VStack
            ...
            <VStack
                    ...
                    {(() => {
                        switch (globalAction) {
                            ...
                            case ActionType.withdraw:
                                return <Withdraw unbondingAmpWHALE={2345} unbondingbWHALE={453} withdrawableAmpWHALE={4536} withdrawablebWHALE={263} isWalletConnected={isWalletConnected} />;
                        }
                    })()}
                </Box>
                {isWalletConnected ? <Button
                    ...
                    style={{ textTransform: "capitalize" }}>
                    {ActionType[globalAction]}
                </Button> : <HStack alignSelf="center">
                    <Wallet
