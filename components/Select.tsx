        ...
        <>
          <PopoverTrigger>
            ...
            >
              <HStack>
                {selected?.icon && (
                  <Image src={selected?.icon} alt="logo-small" boxSize="2rem" />
                )}
                <Text
                  fontSize="20"
                  fontWeight="400"
                  paddingLeft={!selected?.icon && 5}
                >
                  {selected?.label}
                </Text>
              </HStack>
              ...
              {options
                ...
                .map((item, index) => (
                  <HStack
                    ...
                    borderBottom={
                      index === options.length - 2 ? 'unset' : '1px solid'
                    }
                  ...
                  >
                    {item?.icon && (
                      <Image src={item?.icon} alt="logo-small" boxSize="2rem" />
                    )}
