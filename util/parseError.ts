export const parseError = (error: Error) => {
  const customErrors = [
    ...
    { regex: /which exceeds the maximum of 3 flows allowed/i, message: 'Exceeds maximum allowed flows' },
    { regex: /Flow start timestamp is too far into the future/i, message: 'Start date is too far in future' },
  ]
